...
//   ];
//   return (
//     <div className="min-h-screen bg-[#EFEFEF] p-3 space-y-6 sm:p-4 sm:space-y-8 lg:p-6">
...
//         <CardContent className="h-[300px] pt-4 sm:h-[350px] lg:h-[380px]">
...
//                 <CartesianGrid strokeDasharray="3 3" stroke="#E0E0E0" />
//                 <XAxis dataKey="class" stroke="#0FB3B7" tick={{ fontSize: 11 }} interval={0} />
//                 <YAxis stroke="#0FB3B7" />
//                 <Tooltip
//                   contentStyle={{
//                     backgroundColor: 'rgba(15, 179, 183, 0.1)',
...
export default function DashboardCharts({ data }: Props) {
  ...
  return (
    <div className="bg-[#EFEFEF] p-2 space-y-4 sm:p-4 sm:space-y-6 lg:p-6 lg:space-y-8">
      {/* Header with Yellow Accent */}
      <div className="flex items-center gap-2 mb-4 sm:gap-3 sm:mb-6">
        <div className="w-1 h-6 bg-[#FFD700] rounded-full sm:h-8"></div>
        <h2 className="text-base font-bold text-[#0FB3B7] uppercase tracking-wider sm:text-xl">
          Charts & Analytics
        </h2>
      </div>
      ...
      {/* Monthly Income */}
      <Card className="bg-white/70 backdrop-blur-sm border-[#0FB3B7]/20 hover:border-[#0FB3B7]/40 transition-all duration-200 hover:shadow-xl">
        <CardHeader className="border-b border-[#FFD700]/20 p-3 sm:p-6">
          <CardTitle className="text-sm text-[#0FB3B7] flex items-center gap-2 sm:text-base">
            <span className="inline-block w-1.5 h-5 bg-[#FFD700] rounded-full sm:h-6"></span>
            Monthly Income Trend
          </CardTitle>
        </CardHeader>

        <CardContent className="h-[220px] pt-3 px-1 sm:h-[300px] sm:pt-4 sm:px-4 lg:h-[380px]">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data.incomeTrend}>
              <CartesianGrid strokeDasharray="3 3" stroke="#E0E0E0" />
              <XAxis dataKey="month" stroke="#0FB3B7" tick={{ fontSize: 10 }} />
              <YAxis stroke="#0FB3B7" tick={{ fontSize: 10 }} />
              <Tooltip
                contentStyle={{
                  backgroundColor: 'rgba(15, 179, 183, 0.1)',
                  border: '1px solid #0FB3B7',
      ...
      <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-2">
        <Card className="bg-white/70 backdrop-blur-sm border-[#0FB3B7]/20 hover:border-[#0FB3B7]/40 transition-all duration-200 hover:shadow-xl">
          ...
          <CardContent className="h-[250px] pt-3 px-1 sm:h-[350px] sm:pt-4 sm:px-4">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
                  data={data.paymentStatus}
        ...
        <Card className="bg-white/70 backdrop-blur-sm border-[#0FB3B7]/20 hover:border-[#0FB3B7]/40 transition-all duration-200 hover:shadow-xl">
          ...
          <CardContent className="h-[250px] pt-3 px-1 sm:h-[350px] sm:pt-4 sm:px-4">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data.studentsByShift}>
                <CartesianGrid strokeDasharray="3 3" stroke="#E0E0E0" />
                <XAxis dataKey="shift" stroke="#0FB3B7" tick={{ fontSize: 10 }} />
                <YAxis stroke="#0FB3B7" tick={{ fontSize: 10 }} />
                <Tooltip
                  contentStyle={{
                    backgroundColor: 'rgba(15, 179, 183, 0.1)',
        ...
        <Card className="bg-white/70 backdrop-blur-sm border-[#0FB3B7]/20 hover:border-[#0FB3B7]/40 transition-all duration-200 hover:shadow-xl">
          ...
          <CardContent className="h-[250px] pt-3 px-1 sm:h-[350px] sm:pt-4 sm:px-4">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data.studentsByClass}>
                <CartesianGrid strokeDasharray="3 3" stroke="#E0E0E0" />
                <XAxis dataKey="class" stroke="#0FB3B7" tick={{ fontSize: 9 }} interval={0} />
                <YAxis stroke="#0FB3B7" tick={{ fontSize: 10 }} />
                <Tooltip
                  contentStyle={{
                    backgroundColor: 'rgba(15, 179, 183, 0.1)',
      ...
      <Card className="bg-white/70 backdrop-blur-sm border-[#0FB3B7]/20 hover:border-[#0FB3B7]/40 transition-all duration-200 hover:shadow-xl">
        ...
        <CardContent className="h-[280px] pt-3 px-1 sm:h-[350px] sm:pt-4 sm:px-4">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart
              data={[...data.studentsByGroup].sort((a, b) => {
                const order = [
