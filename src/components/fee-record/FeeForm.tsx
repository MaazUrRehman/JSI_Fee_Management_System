...
export function FeeForm({ student, month, receipt, onClose }: { student: Student, month: number, receipt?: Receipt, onClose: () => void }) {
  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="w-[95vw] max-w-[95vw] sm:max-w-lg bg-white/95 backdrop-blur-sm border-[#0FB3B7]/20 shadow-2xl max-h-[90vh] overflow-y-auto p-4 sm:p-6">
        <DialogHeader className="border-b border-[#FFD700]/20 pb-3 sm:pb-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <DialogTitle className="text-[#0FB3B7] text-base font-bold sm:text-xl">
              {isPaid ? "View Receipt" : "Pay Fee"}
            </DialogTitle>
          </div>
        </DialogHeader>
        ...
        <div className="space-y-3 pt-3 sm:space-y-4 sm:pt-4">
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Student Name</Label>
              <Input
                value={student.student_name}
                readOnly
                className="border-[#0FB3B7]/20 bg-[#0FB3B7]/5 text-[#0FB3B7]/90 text-sm"
              />
            </div>
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Student ID</Label>
              <Input
                value={student.student_id}
                readOnly
                className="border-[#0FB3B7]/20 bg-[#0FB3B7]/5 text-[#0FB3B7]/90 text-sm"
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Month</Label>
              <Input
                value={monthName}
                readOnly
                className="border-[#0FB3B7]/20 bg-[#0FB3B7]/5 text-[#0FB3B7]/90 text-sm"
            ...
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Year</Label>
              <Input
                type="number"
                value={selectedYear}
                onChange={(e) => setSelectedYear(e.target.value)}
                readOnly={isPaid}
                className="border-[#0FB3B7]/20 focus:border-[#0FB3B7] focus:ring-[#0FB3B7]/20 text-[#0FB3B7] text-sm"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Issue Date</Label>
              <Input
                type="date"
                value={issueDate}
                onChange={(e) => setIssueDate(e.target.value)}
            ...
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Paid Date</Label>
              <Input
                type="date"
                value={paidDate}
                onChange={(e) => setPaidDate(e.target.value)}
          ...
          {!isPaid && (
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Due Date</Label>
              <Input
                type="date"
                value={dueDate}
                onChange={(e) => setDueDate(e.target.value)}
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Registration Fee</Label>
              <Input
                type="number"
                value={registrationFee}
                onChange={(e) => setRegistrationFee(Number(e.target.value))}
            ...
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Monthly Fee</Label>
              <Input
                type="number"
                value={monthlyFee}
                onChange={(e) => setMonthlyFee(Number(e.target.value))}
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Late Fee</Label>
              <Input
                type="number"
                value={lateFee}
                onChange={(e) => setLateFee(Number(e.target.value))}
            ...
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Stationary / Additional Charges</Label>
              <Input
                type="number"
                value={stationaryCharges}
                onChange={(e) => setStationaryCharges(Number(e.target.value))}
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Previous Balance</Label>
              <Input
                type="number"
                value={previousBalance}
                onChange={(e) => setPreviousBalance(Number(e.target.value))}
            ...
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Discount</Label>
              <Input
                type="number"
                value={discount}
                onChange={(e) => setDiscount(Number(e.target.value))}
          ...
          <div className="grid grid-cols-1 gap-3 border-t border-[#FFD700]/20 pt-3 sm:grid-cols-2 sm:gap-4 sm:pt-4">
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Total Amount</Label>
              <Input
                value={`PKR ${totalAmount.toLocaleString()}`}
                readOnly
                className="border-[#0FB3B7]/20 bg-[#0FB3B7]/10 text-[#0FB3B7] font-bold text-base sm:text-lg"
              />
            </div>
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Paid Amount</Label>
              <Input
                type="number"
                value={paidAmountInput !== null ? paidAmountInput : totalAmount}
                onChange={(e) => setPaidAmountInput(Number(e.target.value))}
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
            <div>
              <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Remaining Amount</Label>
              <Input
                value={`PKR ${remainingAmount.toLocaleString()}`}
                readOnly
                className="border-[#0FB3B7]/20 bg-red-50 text-red-600 font-bold text-sm"
              />
            </div>
            <div>
              {!isPaid ? (
                <>
                  <Label className="text-[#0FB3B7] font-medium text-xs sm:text-sm">Payment Method</Label>
                  <Select value={paymentMethod} onValueChange={(v) => setPaymentMethod(v ?? "Cash")}>
                    <SelectTrigger className="border-[#0FB3B7]/20 focus:border-[#0FB3B7] focus:ring-[#0FB3B7]/20 text-[#0FB3B7] text-sm">
                      <SelectValue placeholder="Select Payment Method" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="Cash" className="text-[#0FB3B7]">Cash</SelectItem>
          ...
          <div className="flex flex-col gap-2 pt-2 sm:flex-row">
            {!isPaid && (
              <Button
                onClick={handlePay}
                disabled={isLoading}
                className="w-full sm:w-auto bg-[#0FB3B7] hover:bg-[#0E9EA2] text-white transition-all duration-200 hover:shadow-lg text-sm"
              >
                {isLoading ? "Processing..." : "Pay Fee"}
              </Button>
            )}
            <Button
              variant="outline"
              onClick={downloadPDF}
              className="w-full sm:w-auto border-[#0FB3B7]/30 text-[#0FB3B7] hover:bg-[#0FB3B7]/10 hover:border-[#0FB3B7]/50 transition-all duration-200 text-sm"
            >
              {isPaid ? "Download Slip" : "Download Voucher"}
            </Button>
            <Button
              variant="ghost"
              onClick={onClose}
              className="w-full sm:w-auto text-[#0FB3B7]/70 hover:text-[#0FB3B7] hover:bg-[#0FB3B7]/10 transition-all duration-200 text-sm"
            >
              Close
            </Button>
          </div>
