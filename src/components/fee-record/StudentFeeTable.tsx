...
export function StudentFeeTable() {
  ...
  return (
    <div className="space-y-3 bg-[#EFEFEF] p-3 rounded-lg sm:space-y-4 sm:p-4">
      <div className="flex items-center justify-between bg-white/50 backdrop-blur-sm rounded-lg p-3 border-l-4 border-[#FFD700] mb-4 sm:p-4 sm:mb-6">
        <div>
      ...
      {/* Filters */}
      <div className="flex flex-col gap-3 bg-white/70 backdrop-blur-sm p-3 rounded-lg border border-[#0FB3B7]/20 sm:flex-row sm:flex-wrap sm:items-end sm:gap-2 sm:p-4">
        <div className="space-y-1 w-full sm:w-auto">
          <Input 
            placeholder="Search by ID or Name..." 
            value={search} 
            onChange={(e) => { setSearch(e.target.value); setCurrentPage(1); }} 
            className="w-full sm:w-48 border-[#0FB3B7]/20 focus:border-[#0FB3B7] focus:ring-[#0FB3B7]/20 text-[#0FB3B7] placeholder:text-[#0FB3B7]/40 text-sm"
          />
        </div>
        <div className="grid grid-cols-2 gap-3 sm:flex sm:gap-2">
          <div className="space-y-1 w-full sm:w-auto">
            ...
            >
              <SelectTrigger className="w-full sm:w-32 border-[#0FB3B7]/20 focus:border-[#0FB3B7] focus:ring-[#0FB3B7]/20 text-[#0FB3B7] text-sm">
                <SelectValue placeholder="All Classes" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="All" className="text-[#0FB3B7]">All Classes</SelectItem>
        ...
        <Button 
          variant="outline" 
          onClick={clearFilters}
          className="w-full sm:w-auto border-[#0FB3B7]/30 text-[#0FB3B7] hover:bg-[#0FB3B7]/10 hover:border-[#0FB3B7]/50 text-sm"
        >
          Clear Filters
        </Button>
      </div>
      ...
      <div className="rounded-lg border border-[#0FB3B7]/20 overflow-hidden bg-white/70 backdrop-blur-sm">
        <Table>
          <TableHeader className="bg-[#0FB3B7]/5">
            <TableRow className="border-b border-[#0FB3B7]/10">
              <TableHead className="text-[#0FB3B7] font-medium text-[10px] sm:text-xs">Student ID</TableHead>
              <TableHead className="text-[#0FB3B7] font-medium text-[10px] sm:text-xs">Student Name</TableHead>
              <TableHead className="text-[#0FB3B7] font-medium text-[10px] sm:text-xs">Father Name</TableHead>
              <TableHead className="text-[#0FB3B7] font-medium text-[10px] sm:text-xs">Class</TableHead>
              <TableHead className="text-[#0FB3B7] font-medium text-[10px] sm:text-xs">Group</TableHead>
              <TableHead className="text-[#0FB3B7] font-medium text-[10px] sm:text-xs">Shift</TableHead>
              <TableHead className="text-[#0FB3B7] font-medium text-[10px] sm:text-xs">Monthly Fee</TableHead>
              <TableHead className="text-[#0FB3B7] font-medium text-[10px] sm:text-xs">Status</TableHead>
              <TableHead className="text-right text-[#0FB3B7] font-medium text-[10px] sm:text-xs">Action</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {paginatedData.map((student) => (
              <TableRow 
                ...
                className="hover:bg-[#0FB3B7]/5 transition-colors border-b border-[#0FB3B7]/5"
              >
                <TableCell className="text-[#0FB3B7]/90 font-medium text-[10px] sm:text-xs">{student.student_id}</TableCell>
                <TableCell className="text-[#0FB3B7]/90 text-[10px] sm:text-xs">{student.student_name}</TableCell>
                <TableCell className="text-[#0FB3B7]/80 text-[10px] sm:text-xs">{student.father_name}</TableCell>
                <TableCell className="text-[#0FB3B7]/90 text-[10px] sm:text-xs">{student.class}</TableCell>
                <TableCell className="text-[#0FB3B7]/80 text-[10px] sm:text-xs">{student.student_group}</TableCell>
                <TableCell className="text-[#0FB3B7]/80 text-[10px] sm:text-xs">{student.shift}</TableCell>
                <TableCell className="text-[#0FB3B7]/90 font-medium text-[10px] sm:text-xs">PKR {student.monthly_fee}</TableCell>
                <TableCell>
                  <span className={student.status === "Active" ? 
                    "px-1.5 py-0.5 rounded-full text-[10px] font-medium bg-[#0FB3B7]/10 text-[#0FB3B7] sm:px-2 sm:py-1 sm:text-xs" : 
                    "px-1.5 py-0.5 rounded-full text-[10px] font-medium bg-red-100 text-red-600 sm:px-2 sm:py-1 sm:text-xs"
                  }>
                    {student.status}
                  </span>
                </TableCell>
                <TableCell className="text-right">
                  <Button 
                    ...
                    size="sm" 
                    onClick={() => setSelectedStudent(student)}
                    className="border-[#0FB3B7]/30 text-[#0FB3B7] hover:bg-[#0FB3B7]/10 hover:border-[#0FB3B7]/50 transition-all duration-200 text-[10px] h-7 px-1.5 sm:text-xs sm:h-8 sm:px-3"
                  >
                    <FileText className="h-3 w-3 sm:mr-2 sm:h-4 sm:w-4" />
            ...
            {paginatedData.length === 0 && (
              <TableRow>
                <TableCell colSpan={9} className="text-center py-8 text-[#0FB3B7]/40 text-xs sm:text-sm">
                  No students found
                </TableCell>
              </TableRow>
            )}
      ...
      {/* Pagination */}
      <div className="flex flex-col gap-3 bg-white/70 backdrop-blur-sm p-3 rounded-lg border border-[#0FB3B7]/20 sm:flex-row sm:items-center sm:justify-between sm:p-4">
        <span className="text-xs text-[#0FB3B7]/70 text-center sm:text-left sm:text-sm">
          Showing {(currentPage - 1) * pageSize + 1}–{Math.min(currentPage * pageSize, processedData.length)} of {processedData.length} Students
        </span>
